 ...
 *
 * AI provider spending cap behavior is often inconsistent:
 ...
 * Used by message handlers and the behavioral heuristic.
 */
 ...
 * Used by error classification in error-handling services.
 */
 ...
 *
 * When a model hits a spending cap, it often returns a short message
