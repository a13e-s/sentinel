...
export const SaveDeliverableInputSchema = z.object({
  ...
  file_path: z.string().optional().describe('Path to a file whose contents should be used as the deliverable content. Relative paths are resolved against the deliverables directory.'),
});
